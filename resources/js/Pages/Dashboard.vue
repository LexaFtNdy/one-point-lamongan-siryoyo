...
<template>
    ...
    <div class="space-y-8 pb-10">
        ...
        <div class="relative overflow-hidden rounded-[2.5rem] bg-[#121212]/80 backdrop-blur-xl border border-white/10 p-8 sm:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.5)] group">
            ...
            <div class="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
                <div class="text-center lg:text-left flex-1">
                    ...
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-4 leading-tight">
                ...
                <div class="flex-shrink-0">
                    <Link
                        ...
                        class="relative inline-flex items-center justify-center gap-3 px-10 py-5 bg-white text-black font-bold rounded-full overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] group/btn"
                    >
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <!-- Card 1: Jadwal Aktif -->
            <Link :href="route('member.bookings')" class="relative overflow-hidden bg-[#121212]/60 backdrop-blur-md border border-white/5 rounded-3xl p-6 hover:border-gym-red/30 hover:bg-[#1a1a1a]/80 transition-all duration-500 group transform hover:-translate-y-1">
            ...
            <Link :href="route('member.bookings')" class="relative overflow-hidden bg-[#121212]/60 backdrop-blur-md border border-white/5 rounded-3xl p-6 hover:border-gym-yellow/30 hover:bg-[#1a1a1a]/80 transition-all duration-500 group transform hover:-translate-y-1">
            ...
            <Link :href="route('member.bookings')" class="relative overflow-hidden bg-[#121212]/60 backdrop-blur-md border border-white/5 rounded-3xl p-6 hover:border-blue-500/30 hover:bg-[#1a1a1a]/80 transition-all duration-500 group transform hover:-translate-y-1">
