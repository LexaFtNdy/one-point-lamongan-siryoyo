...
<template>
    <dialog
        class="z-50 m-0 min-h-full min-w-full overflow-y-auto scrollbar-hide bg-transparent backdrop:bg-transparent"
        ref="dialog"
    >
        <div
            class="fixed inset-0 z-50 overflow-y-auto scrollbar-hide px-4 py-6 sm:px-0"
            scroll-region
        >
            <Transition
